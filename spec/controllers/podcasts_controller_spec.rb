...
describe PodcastsController do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested podcast" do
        ...
        Podcast.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, :id => podcast.id, :podcast => {'these' => 'params'}
      end

      it "assigns the requested podcast as @podcast" do
        podcast = Podcast.create! valid_attributes
        put :update, :id => podcast.id, :podcast => valid_attributes
        assigns(:podcast).should eq(podcast)
      end
    ...
    describe "with invalid params" do
      it "assigns the podcast as @podcast" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Podcast.any_instance.stub(:save).and_return(false)
        put :update, :id => podcast.id.to_s, :podcast => {}
        assigns(:podcast).should eq(podcast)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested podcast" do
      podcast = Podcast.create! valid_attributes
      expect {
        delete :destroy, :id => podcast.id.to_s
      }.to change(Podcast, :count).by(-1)
    end
